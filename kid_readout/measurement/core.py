...
class Measurement(object):
    ...
    def write(self, writer, location, name):
        ...
        :return: the location to which this measurement was written.
...
# Import all classes that are subclasses of either Measurement or MeasurementSequence from the subpackage measurements
_measurements = {}
