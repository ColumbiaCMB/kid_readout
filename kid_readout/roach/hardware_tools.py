...
def r2_with_mk1(**kwargs):
    return r2h14_with_mk1(**kwargs)


def r2h14_with_mk2(**kwargs):
...
def r1h11nc_with_mk1(**kwargs):
    return heterodyne.Roach1Heterodyne11NarrowChannel(roachip=ROACH1_IP, adc_valon=ROACH1_VALON, host_ip=ROACH1_HOST_IP,
                                                      lo_valon=None, attenuator=None, **kwargs)


def r1h11nc_with_mk2(**kwargs):
    if MARK2_VALON is None:  # If lo_valon is None the roach will use its internal valon, with unfortunate results.
        raise ValueError("MARK2_VALON is None.")
    return heterodyne.Roach1Heterodyne11NarrowChannel(roachip=ROACH1_IP, adc_valon=ROACH1_VALON, host_ip=ROACH1_HOST_IP,
                                                      lo_valon=MARK2_VALON, attenuator=attenuator.Attenuator(),
                                                      **kwargs)


def r1h09nc_with_mk1(**kwargs):
    return heterodyne.Roach1Heterodyne09NarrowChannel(roachip=ROACH1_IP, adc_valon=ROACH1_VALON, host_ip=ROACH1_HOST_IP,
                                                      lo_valon=None, attenuator=None, **kwargs)


def r1h09nc_with_mk2(**kwargs):
    if MARK2_VALON is None:  # If lo_valon is None the roach will use its internal valon, with unfortunate results.
        raise ValueError("MARK2_VALON is None.")
    return heterodyne.Roach1Heterodyne09NarrowChannel(roachip=ROACH1_IP, adc_valon=ROACH1_VALON, host_ip=ROACH1_HOST_IP,
                                                      lo_valon=MARK2_VALON, attenuator=attenuator.Attenuator(),
