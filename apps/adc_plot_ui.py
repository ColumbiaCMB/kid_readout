...
#
# Created: Fri Nov  1 13:17:30 2013
...
class Ui_AdcPlotDialog(object):
    def setupUi(self, AdcPlotDialog):
        ...
        self.check_demod = QtGui.QCheckBox(AdcPlotDialog)
        self.check_demod.setText(QtGui.QApplication.translate("AdcPlotDialog", "demodulate", None, QtGui.QApplication.UnicodeUTF8))
        self.check_demod.setObjectName(_fromUtf8("check_demod"))
        self.horizontalLayout_3.addWidget(self.check_demod)
