...
group_1_f0 = all_f0s[all_f0s<1300] - 0.5
...
for group_num,(lo,f0s) in enumerate(zip([group_1_lo,group_2_lo],[group_1_f0,group_2_f0])):
    ...
    for hittite_power in [0]: #np.arange(-3.4,1.1,0.2):
    ...
    #        raw_input("press enter to start")
            ...
            for iset in range(nsets):
                ...
                time.sleep(0.4)
                t0 = time.time()
                dmod, addr = ri.get_data(256*16) # about 30 seconds of data
