...
if True:
    ...
    for k in np.unique(coarse_sweep.sweep_indexes):
        ...
        res = kid_readout.analysis.resonator.legacy_resonator.fit_best_resonator(fr, s21, errors=err, delay_estimate=ri.hardware_delay_estimate * 1e6)
        fits.append(res)
...
while True:
    ...
    projected = d[:,highlight]*ri.wavenorm
