...
# Parameters
suffix = "magnetic_shield"
#height_mm = 0  # no lab jack
#orientation = -1  # down
dummy_MHz = 170
f0_MHz = np.array([78.350, 116.164, 160.815, dummy_MHz])
attenuations = [17, 23, 29, 35, 41, 38, 44]
fft_gains = [3, 4, 5, 6, 6, 6, 6]
tone_sample_exponent_coarse = 19
tone_sample_exponent_fine = 21
