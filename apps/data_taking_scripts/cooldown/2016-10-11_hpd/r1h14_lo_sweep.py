...
tone_sample_exponent = 17
sweep_spacing = 2
# This should sweep across one entire bin, with 8 tones in the bin.
n_lo_offset = np.arange(-8, 9, 1)
...
n_baseband_sweep = minimum_integer_sweep + sweep_spacing * np.arange(num_tones_sweep)
