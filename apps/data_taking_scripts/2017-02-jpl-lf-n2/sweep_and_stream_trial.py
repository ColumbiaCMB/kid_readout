...
all_f0s = np.load('/data/readout/resonances/2017-02-15-JPL-8x8-LF-N2_resonances.npy')/1e6

#mask = [1,20,59,70] #try one

#mask = [3, 15, 30, 60]

mask = [2, 16, 25, 39, 55, 65, 74, 88]

new_mask = [d+1 for d in mask]

initial_f0s = all_f0s[new_mask]
