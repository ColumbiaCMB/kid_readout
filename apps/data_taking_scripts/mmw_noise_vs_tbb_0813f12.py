...
suffix = "mmwnoisestep"
mmw_source_modulation_freq = 1/(128*64e-6)
...
heater_voltages = [0.25,0.5,1.0,1.5,2.0,2.5]
print heater_voltages
...
#while True:
    ...
    while time.time() < tstart + wait_time:
        print "%.1f minutes remaining" % ((wait_time - (time.time()-tstart))/60.0)
        time.sleep(5*60)
