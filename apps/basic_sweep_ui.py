...
class Ui_SweepDialog(object):
    def setupUi(self, SweepDialog):
        ...
        self.verticalLayout_6 = QtGui.QVBoxLayout(SweepDialog)
        ...
        self.verticalLayout_6.addWidget(self.plot_group_box)
        ...
        self.verticalLayout.addWidget(self.push_start_sweep)
        self.push_abort = QtGui.QPushButton(self.groupBox)
        self.push_abort.setText(QtGui.QApplication.translate("SweepDialog", "Abort", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.push_start_fine_sweep.setText(QtGui.QApplication.translate("SweepDialog", "Start Sweep", None, QtGui.QApplication.UnicodeUTF8))
        self.push_start_fine_sweep.setAutoDefault(False)
        self.push_start_fine_sweep.setObjectName(_fromUtf8("push_start_fine_sweep"))
        self.verticalLayout_4.addWidget(self.push_start_fine_sweep)
        spacerItem2 = QtGui.QSpacerItem(17, 37, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
