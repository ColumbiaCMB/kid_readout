...
def process_file(filename):
    ...
    for resonator_id in resonator_ids:
        noise_on_measurement = SweepNoiseMeasurement(sweep_filename=filename, sweep_group_index=0, timestream_group_index=0,
        ...
        noise_modulated_measurement.folded_projected_timeseries = noise_modulated_measurement.projected_timeseries.reshape((-1,64))
        ...
        noise_modulated_measurement.folded_projected_timeseries = np.roll(noise_modulated_measurement.folded_projected_timeseries,
                                                                          -rising_edge,axis=1)
        ...
        noise_on_measurements.append(noise_on_measurement)
